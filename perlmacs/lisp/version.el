;; Modified 30 Jan 1998 by John Tobey for embedded Perl
...
(defconst perlmacs-version "0.10" "\
Version numbers of the Perlmacs patch applied to this Emacs.")

;; Gawd this would be so much easier in Perl.  :-)
(defconst perlmacs-major-version
  (progn (string-match "^[0-9]+" perlmacs-version)
	 (string-to-int (match-string 0 perlmacs-version)))
  "Major version number of this version of Perlmacs.")

(defconst perlmacs-minor-version
  (progn (string-match "^[0-9]+\\.\\([0-9]+\\)" perlmacs-version)
	 (string-to-int (match-string 1 perlmacs-version)))
  "Minor version number of this version of Perlmacs.")
